...
strategy = 'REBAGG-GN'   # Replace REBAGG-GN for this calculation
params = all_params[strategy]  
param = params[56]   # Replace 56 for this calculation
...
joblib.dump(store, f'hpc/joblib_files/{strategy}_{56}.pkl')
