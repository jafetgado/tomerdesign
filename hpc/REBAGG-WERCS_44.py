...
strategy = 'REBAGG-WERCS'   # Replace REBAGG-WERCS for this calculation
params = all_params[strategy]  
param = params[44]   # Replace 44 for this calculation
...
joblib.dump(store, f'hpc/joblib_files/{strategy}_{44}.pkl')
