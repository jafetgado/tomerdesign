...
(Evaluates the performance of a strategy for a single set of hyperparameter combinations)
"""
...
strategy = 'STRATEGY'   # Replace STRATEGY for this calculation
params = all_params[strategy]  
param = params[I_PARAM]   # Replace I_PARAM for this calculation
...
joblib.dump(store, f'hpc/joblib_files/{strategy}_{I_PARAM}.pkl')
